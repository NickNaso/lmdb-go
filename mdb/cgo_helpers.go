...
// NewEnvRef initialises a new struct.
...
// NewTxnRef initialises a new struct.
...
// NewCursorRef initialises a new struct.
...
func NewValRef(ref interface{}) *Val {
	if ref == nil {
		return nil
	}
	...
	obj := new(Val)
	obj.reff5baf417 = (*C.MDB_val)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func cmpFuncE2FAE82F(ca *C.MDB_val, cb *C.MDB_val) C.int {
	if cmpFuncE2FAE82FFunc != nil {
		ae2fae82f := NewValRef(ca)
		be2fae82f := NewValRef(cb)
...
func NewStatsRef(ref interface{}) *Stats {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(Stats)
	obj.ref9ed18a7f = (*C.MDB_stat)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewEnvinfoRef(ref interface{}) *Envinfo {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(Envinfo)
	obj.refea477e79 = (*C.MDB_envinfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
