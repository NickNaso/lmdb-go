...
func (x *Val) PassRef() (*C.MDB_val, *cgoAllocMap) {
	...
	reff5baf417.mv_size, cmv_size_allocs = (C.size_t)(x.MvSize), cgoAllocsUnknown
	allocsf5baf417.Borrow(cmv_size_allocs)

	var cmv_data_allocs *cgoAllocMap
	reff5baf417.mv_data, cmv_data_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.MvData)), cgoAllocsUnknown
...
func (x *Val) Deref() {
	...
	x.MvSize = (uint)(x.reff5baf417.mv_size)
	x.MvData = (unsafe.Pointer)(unsafe.Pointer(x.reff5baf417.mv_data))
}
...
// allocDbStatMemory allocates memory for type C.MDB_stat in C.
// The caller is responsible for freeing the this memory via C.free.
func allocDbStatMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfDbStatValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfDbStatValue = unsafe.Sizeof([1]C.MDB_stat{})

// Ref returns a reference.
func (x *DbStat) Ref() *C.MDB_stat {
	if x == nil {
		return nil
	}
...
// NewDbStatRef initialises a new struct holding the reference to the originaitng C struct.
func NewDbStatRef(ref *C.MDB_stat) *DbStat {
	if ref == nil {
		return nil
	}
	obj := new(DbStat)
...
// PassRef returns a reference and creates new C object if no refernce yet.
func (x *DbStat) PassRef() (*C.MDB_stat, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref9ed18a7f != nil {
		return x.ref9ed18a7f, nil
	}
	mem9ed18a7f := allocDbStatMemory(1)
	ref9ed18a7f := (*C.MDB_stat)(mem9ed18a7f)
	allocs9ed18a7f := new(cgoAllocMap)
	var cms_psize_allocs *cgoAllocMap
	ref9ed18a7f.ms_psize, cms_psize_allocs = (C.uint)(x.MsPsize), cgoAllocsUnknown
	allocs9ed18a7f.Borrow(cms_psize_allocs)

	var cms_depth_allocs *cgoAllocMap
	ref9ed18a7f.ms_depth, cms_depth_allocs = (C.uint)(x.MsDepth), cgoAllocsUnknown
	allocs9ed18a7f.Borrow(cms_depth_allocs)

	var cms_branch_pages_allocs *cgoAllocMap
	ref9ed18a7f.ms_branch_pages, cms_branch_pages_allocs = (C.mdb_size_t)(x.MsBranchPages), cgoAllocsUnknown
	allocs9ed18a7f.Borrow(cms_branch_pages_allocs)

	var cms_leaf_pages_allocs *cgoAllocMap
	ref9ed18a7f.ms_leaf_pages, cms_leaf_pages_allocs = (C.mdb_size_t)(x.MsLeafPages), cgoAllocsUnknown
	allocs9ed18a7f.Borrow(cms_leaf_pages_allocs)

	var cms_overflow_pages_allocs *cgoAllocMap
	ref9ed18a7f.ms_overflow_pages, cms_overflow_pages_allocs = (C.mdb_size_t)(x.MsOverflowPages), cgoAllocsUnknown
	allocs9ed18a7f.Borrow(cms_overflow_pages_allocs)

	var cms_entries_allocs *cgoAllocMap
	ref9ed18a7f.ms_entries, cms_entries_allocs = (C.mdb_size_t)(x.MsEntries), cgoAllocsUnknown
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *DbStat) PassValue() (C.MDB_stat, *cgoAllocMap) {
	if x == nil {
		x = NewDbStatRef(nil)
	} else if x.ref9ed18a7f != nil {
		return *x.ref9ed18a7f, nil
...
func (x *DbStat) Deref() {
	...
	x.MsPsize = (uint32)(x.ref9ed18a7f.ms_psize)
	x.MsDepth = (uint32)(x.ref9ed18a7f.ms_depth)
	x.MsBranchPages = (Size)(x.ref9ed18a7f.ms_branch_pages)
	x.MsLeafPages = (Size)(x.ref9ed18a7f.ms_leaf_pages)
	x.MsOverflowPages = (Size)(x.ref9ed18a7f.ms_overflow_pages)
	x.MsEntries = (Size)(x.ref9ed18a7f.ms_entries)
}
...
func (x *Envinfo) PassRef() (*C.MDB_envinfo, *cgoAllocMap) {
	...
	refea477e79.me_mapaddr, cme_mapaddr_allocs = *(*unsafe.Pointer)(unsafe.Pointer(&x.MeMapaddr)), cgoAllocsUnknown
	allocsea477e79.Borrow(cme_mapaddr_allocs)

	var cme_mapsize_allocs *cgoAllocMap
	refea477e79.me_mapsize, cme_mapsize_allocs = (C.mdb_size_t)(x.MeMapsize), cgoAllocsUnknown
	allocsea477e79.Borrow(cme_mapsize_allocs)

	var cme_last_pgno_allocs *cgoAllocMap
	refea477e79.me_last_pgno, cme_last_pgno_allocs = (C.mdb_size_t)(x.MeLastPgno), cgoAllocsUnknown
	allocsea477e79.Borrow(cme_last_pgno_allocs)

	var cme_last_txnid_allocs *cgoAllocMap
	refea477e79.me_last_txnid, cme_last_txnid_allocs = (C.mdb_size_t)(x.MeLastTxnid), cgoAllocsUnknown
	allocsea477e79.Borrow(cme_last_txnid_allocs)

	var cme_maxreaders_allocs *cgoAllocMap
	refea477e79.me_maxreaders, cme_maxreaders_allocs = (C.uint)(x.MeMaxreaders), cgoAllocsUnknown
	allocsea477e79.Borrow(cme_maxreaders_allocs)

	var cme_numreaders_allocs *cgoAllocMap
	refea477e79.me_numreaders, cme_numreaders_allocs = (C.uint)(x.MeNumreaders), cgoAllocsUnknown
...
func (x *Envinfo) Deref() {
	...
	x.MeMapaddr = (unsafe.Pointer)(unsafe.Pointer(x.refea477e79.me_mapaddr))
	x.MeMapsize = (Size)(x.refea477e79.me_mapsize)
	x.MeLastPgno = (Size)(x.refea477e79.me_last_pgno)
	x.MeLastTxnid = (Size)(x.refea477e79.me_last_txnid)
	x.MeMaxreaders = (uint32)(x.refea477e79.me_maxreaders)
	x.MeNumreaders = (uint32)(x.refea477e79.me_numreaders)
}
